			...
			<div class="container">
				<s:form namespace="/user" action="register" method="post" theme="bootstrap" cssClass="form">
					...
					<div class="form-group">
						...
						<s:textfield id="registration.username" name="registration.username" placeholder="%{getText('sign-up-form.username')}" autofocus="autofocus" cssClass="form-control" />
						<s:fielderror fieldName="registration.username" />
					</div>
					<div class="form-group">
						<label for="registration.password"><s:text name="sign-up-form.password"/></label>
						<s:password id="registration.password" name="registration.password" placeholder="%{getText('sign-up-form.password')}" cssClass="form-control" />
					...
					<div class="form-group">
						...
						<s:password id="registration.confirmedPassword" name="registration.confirmedPassword" placeholder="%{getText('sign-up-form.confirm-password')}" cssClass="form-control" />
